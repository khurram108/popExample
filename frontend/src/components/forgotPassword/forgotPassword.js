...
function ChangePassword(props) {
    ...
    useEffect(() => {
            ...
            setSuccess(error.password_changed_successfully)
            setTimeout(() => {
                setSuccess(null)
            }, 5000);
        
    }, [error.password_changed_successfully])
                        ...
                        <div className="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                            <div
                                ...
                                <div className="intro-x mt-8">
                                    ...
                                    <input type="password" className="intro-x login__input input input--lg border border-gray-300 block"
                                        placeholder="Enter a New Password" onChange={onChangeHandler} name="newPassword" />
                                    <input type="password"
                                        className="intro-x login__input input input--lg border border-gray-300 block mt-4"
                                        placeholder="Confirm Password" onChange={onChangeHandler} name="confirmNewPassword" />
                                </div>
                                ...
                                <div className="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                                    <button className="button button--lg w-full xl:w-40 text-white bg-theme-1 xl:mr-3" onClick={submit}>
                                        Change Password
                                    </button>
                                    <Link to='/login'>
                                        <button
